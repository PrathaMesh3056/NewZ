...
export class Newsitem extends Component {
  ...
  handleSummarize = () => {
    // *** MODIFIED: Destructure currentLanguage from props ***
    let { title, description, imageUrl, newsUrl, author, date, source, currentLanguage } = this.props;

    // *** FIX: Determine the text to summarize. Use title if description is missing or too short. ***
    const textToSummarize = (description && description.trim().length > 20) ? description : title;
    ...
    this.setState({
      ...
      redirect: {
        ...
        state: {
          title,
          description: textToSummarize, // Pass the determined text to the summary page
          imageUrl: imageUrl || "/Newz_logo.png",
          author,
          date,
          source,
          newsUrl,
          shouldSummarize: true,
          // *** ADDED: Pass the language to the summary page state ***
      ...
      <div className="group h-full flex">
        <article className="flex flex-col bg-white dark:bg-gray-900 rounded-lg shadow-sm border border-gray-200 dark:border-gray-800 overflow-hidden ring-1 ring-gray-100 hover:ring-gray-200 hover:shadow-lg transition duration-300 will-change-transform hover:-translate-y-0.5 h-full w-full">
          ...
          <div className="relative aspect-video overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900">
            ...
            <div className={`w-full h-full flex-col items-center justify-center p-4 text-center ${imageUrl ? 'hidden absolute inset-0' : 'flex'} bg-white/90 dark:bg-gray-900/90`}>
              ...
              <div className="mt-auto">
                ...
                <div className="flex items-center justify-between gap-2 pt-2 border-t border-gray-100 dark:border-gray-800">
                  ...
                  >
                    ...
                    {this.state.isSummarizing ? "Summarizing..." : "Summarize"}
                  </button>
                </div>

                {/* *** RESTORED: Share buttons *** */}
                  ...
                  {(() => {
                    ...
                    return (
                      <>
                        ...
                        >
                          <span>
                            <svg className="transition-all duration-300 group-hover:scale-110" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 72 72" fill="none">
                        ...
                        >
                          <span>
                            <svg className="rounded-md transition-all duration-300 group-hover:scale-110" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 72 72" fill="none">
                        ...
                        >
                          <span >
                            <svg className="transition-all duration-300 group-hover:scale-110" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 71 72" fill="none">
